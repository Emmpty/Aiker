	...
	<view class="uni-cursor-point">
		...
		<view :class="{
		  ...
		  'uni-fab__content--other-platform': !isAndroidNvue
			...
			<view style="font-size: 14px;" :class="{'uni-fab__plus--active': isShow && content.length > 0}">开始</view>
			<!-- <view class="fab-circle-v"  :class="{'uni-fab__plus--active': isShow && content.length > 0}">开始</view> -->
			<!-- <view class="fab-circle-h" :class="{'uni-fab__plus--active': isShow  && content.length > 0}">绘制</view> -->
		</view>
	</view>
</template>
