      ...
      >
        ...
        <template v-if="imageRect && cropperRect">
          ...
          <image
            ...
            :change:imageRect="wxsModule.changeImageRect"
            :imageRect="imageRect"
            :class="{ anim }"
          >
            <!-- #endif -->
            ...
            <view
              class="cropper"
              :class="{ anim }"
              :change:cropperRect="wxsModule.changeCropper"
              :cropperRect="cropperRect"
              :change:ratio="wxsModule.changeRatio"
              :ratio="ratio"
            >
              <!-- #endif -->
              <!-- #ifndef APP-VUE || MP-WEIXIN || MP-QQ || H5 -->
              ...
              >
                ...
                <!-- #endif -->
                <!-- #ifndef APP-VUE || MP-WEIXIN || MP-QQ || H5  -->
                <view class="controller vertical left" />
                <view class="controller vertical right" />
                <view class="controller horizon top" />
                <view class="controller horizon bottom" />
                <view class="controller left top" />
                <view class="controller left bottom" />
                <view class="controller right top" />
                <view class="controller right bottom" />
                <!-- #endif -->
